    ...
    public function generatePaymentLink($Payment, $callbackUrl)
    {
        try {
            ...
            $preferenceRequest = [
                ...
                "payer" => $payer,
                "back_urls" => [
                    'success' => 'https://crm.jrmaker.com.co/payment/success',
                    'failure' => 'https://crm.jrmaker.com.co/payment/failure',
                    'pending' => 'https://crm.jrmaker.com.co/payment/pending',
                ],
                "auto_return" => 'approved',
                "notification_url" => 'https://crm.jrmaker.com.co/payment/callback',
